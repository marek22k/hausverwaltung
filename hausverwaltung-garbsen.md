...
<section style="padding:24px 20px;margin-bottom:2.5rem;max-width:800px;margin-left:auto;margin-right:auto;">
  ...
  <ul style="list-style:none;padding-left:0;line-height:1.8;font-size:16px;margin-top:1rem;">
    <li style="margin-bottom:0.5rem;"><strong>Stadtpark Garbsen mit Schwarzem See</strong><br>Beliebtes Naherholungsgebiet für Spaziergänge und Freizeit</li>
    <li style="margin-bottom:0.5rem;"><strong>Barockkirche Schloß Ricklingen</strong><br>Sehenswertes historisches Sakralbauwerk in Berenbostel</li>
    <li><strong>Naturschutzgebiet Ricklinger Entenpool</strong><br>Naturnahe Umgebung nahe Schloss Ricklingen</li>
  </ul>
</section>
...
<p style="text-align:center;margin-top:3rem;color:#666;font-size:15px;">Hausverwaltung Marco Müller – Ihr Verwalter für Garbsen & Region Hannover</p>
